...
export const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    category: 'Accounting',
    highlights: [
      'Produce monthly income/expenditure reporting and variance analysis for university faculties and divisions.',
      'Lead in-year budgeting, forecasting and financial performance tracking.',
      'Provide financial modelling and commercial support to budget holders and senior stakeholders.',
    ],
    skillsUsed: [
  ...
  },
  {
    ...
    highlights: [
      'Provided 1st and 2nd line support and systems configuration for Unit4 ERPx and integrated financial applications.',
      'Investigated and resolved accounting system discrepancies across journal postings, automated workflows, and bank feeds.',
      'Maintained Chart of Accounts, VAT tax rules, automated BACS payment runs, and audit compliance documentation.',
    ],
    skillsUsed: [
      'Financial Systems',
      'Unit4 ERPx',
  ...
  },
  {
    ...
    highlights: [
      'Co-founded online accounting education platform, guiding the venture from market research to live platform launch.',
      'Designed practical curriculum for UK tax, VAT, and double-entry bookkeeping modules.',
      'Built and deployed the digital learning environment, overseeing user experience and module exercise workflows.',
    ],
    skillsUsed: [
      'EdTech Management',
      'UK Tax Curriculum',
  ...
  },
  {
    ...
    category: 'Education & Management',
    highlights: [
      'Supervised day-to-day operations and departmental budgets for accredited accounting training programs.',
      'Developed and delivered accredited coursework aligned with HMRC legislation and accounting software updates.',
      'Led, mentored, and scheduled a multidisciplinary team of finance instructors and administrative staff.',
    ],
    skillsUsed: [
  ...
  },
  {
    ...
    category: 'Education & Management',
    highlights: [
      'Delivered hands-on practical software training in Xero, QuickBooks, and Excel to aspiring finance professionals.',
      'Guided learners through UK tax compliance case studies including VAT, Self-Assessment, and Corporation Tax.',
      'Integrated modern AI workflows to streamline student coursework and payroll exercise delivery.',
    ],
    skillsUsed: [
      'Xero & QuickBooks',
      'UK Tax Coaching',
  ...
  },
  {
    ...
    category: 'Accounting',
    highlights: [
      'Prepared complete statutory financial statements (FRS 102) and quarterly VAT returns for 20+ SME practice clients.',
      'Processed multi-company payroll runs (PAYE, NI, pensions) and bank reconciliations for 1,000+ monthly transactions.',
      'Implemented Dext AI automation to streamline invoice processing, boosting operational turnaround by 30%.',
    ],
    skillsUsed: [
      'Statutory Accounts',
      'VAT Returns',
  ...
  },
  {
    ...
    category: 'Accounting',
    highlights: [
      'Maintained sales and purchase ledgers across Sage 50, QuickBooks, and Xero for practice clients.',
      'Prepared, reconciled, and submitted quarterly VAT returns under Making Tax Digital (MTD) standards.',
      'Assisted senior accountants with monthly balance sheet and trial balance reconciliations.',
    ],
    skillsUsed: [
      'Sage 50',
  ...
  },
  {
    ...
    category: 'Accounting',
    highlights: [
      'Executed double-entry bookkeeping, ledger maintenance, and bank reconciliations across diverse SMEs.',
      'Generated compliant employee payslips, year-end P60s, and leaver P45 payroll documentation.',
      'Assisted in preparing VAT schedules and routine HMRC compliance filings.',
    ],
    skillsUsed: [
