...
export const FinanceProjects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Projects List with Rich LinkedIn Media Format */}
      <div className="space-y-12">
        {filteredProjects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className="reveal rounded-3xl bg-neutral-900/70 border border-neutral-800 hover:border-neutral-700/80 transition-all p-6 sm:p-8 overflow-hidden"
            >
              {/* Project Card Header */}
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 pb-6 border-b border-neutral-800">
                <div>
                  <div className="flex items-center gap-3 flex-wrap mb-2">
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] font-mono text-neutral-400 bg-neutral-800/80 px-2 py-0.5 rounded">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  {project.url && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-neutral-950 text-xs font-semibold font-sans transition-all shadow-sm shadow-emerald-500/20"
                    >
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-neutral-200 text-xs font-mono transition-colors border border-neutral-700"
                    >
              ...
              {/* Interactive LinkedIn-style Media Tabs & Feature Breakdown */}
              {project.mediaTabs.length > 0 && (
